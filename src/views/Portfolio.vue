        ...
        <b-col cols="sm-9" class="label-content label-ribbon text-left py-md-2 py-sm-0">
          <p class="mb-0">
            <ul class="mb-0 list-group list-group-flush" height="100%">
              <li class="list-group-item">ikeda-port-site（Vue.cli、heroku）<br>【<a href="https://ikd-port-site.herokuapp.com/">リンク</a>】【<a href="https://github.com/yuhkiikd/ikd-port-site" target="_blank">github</a>】</li>
